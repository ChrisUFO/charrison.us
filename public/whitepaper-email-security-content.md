...
*GLM-5.1 tested via Z.AI API. Pricing estimated at GLM-5 rates ($0.72 input / $2.30 output per 1M tokens) since GLM-5.1 has no public per-token pricing. Only available via Z.AI coding plan ($10/month).*
